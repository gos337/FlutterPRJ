...
class Content {
  ...
  @override
  String toString() {
    return 'Content(key: $key, title: $title, type: $type, desc: $desc, exerciseCalorie: $exerciseCalorie, exerciseTimeSec: $exerciseTimeSec, newBadgeYn: $newBadgeYn, vod: $vod, thumbUrl: $thumbUrl, imageUrl: $imageUrl, count: $count, trainers: $trainers, favoriteYn: $favoriteYn, level: $level, previewSection: $previewSection, exerciseType: $exerciseType, progressTimeSec: $progressTimeSec, startDt: $startDt, endDt: $endDt, freeYn: $freeYn, episodeInfo: $episodeInfo, summary: $summary, restTimeSec: $restTimeSec, recommendCount: $recommendCount, hits: $hits, execCount: $execCount, filterYn: $filterYn, monthlyViewCount: $monthlyViewCount, tags: $tags, metas: $metas, contents: $contents, sections: $sections, latestProgressDate: $latestProgressDate)';
  }
}
